    ...
    return [
        {
            ...
            'template':[
                ...
                {'tpl' : '<div class="inter_size" id="int_2" data="2"><div class="flecha" style="top: 250px; left: 250px;"></div><button class="button" id="btn_historia"></button><div class="flecha" style="top: 250px; left: 890px;"></div><button class="button button" id="btn_jugar"></button></div>'},
        
                {'tpl' : '<div class="inter_size" id="fondo"><div class="flecha" style="top: 130px; left: 310px;"></div><div class="flecha" style="top: 130px; left: 860px;"></div><h1 style = "position: absolute; top: 300px; left: 235px;">Necesidad o Deseo</h1><h1 style = "position: absolute; top: 300px; left: 840px;">El ahorro</h1><button class="boton" id="btn_nd"></button><button class="boton button" id="btn_ahorro"></button><button class="boton button btn_atras" id="btn_menu_atras"></button></div>'}
        ...
        },
        {
            ...
            'template': [
                ...
                {'tpl' : '<div class="inter_size" id="int_debcred"><h2 id="cyd_cont">{{text}}</h2><button class="boton" id="btn_cred">Crédito</button><button class="boton" id="btn_deb">Débito</button><button class="boton button btn_atras_h"></button><button class="boton button btn_sig_h"></button></div>', 'title' : "Tarjetas de Débito y Crédito", 'deb' : "Tarjeta de débito: vinculada directamente a la cuenta (ahorro o comprobación). Cuando se utiliza el dinero se toma directamente de la cuenta.", 'cred' : "Tarjeta de crédito: es un medio de pago que le permite hacer compras que puede pagar posteriormente (una semana después, un mes después, un año después, etc). Son llamadas “de crédito” porque cuando paga cualquier mercancía con ella, el banco que se la otorgó te está concediendo un préstamo que debe pagar de acuerdo al período que elija según los plazos negociados con la entidad."}
            ],
        ...
        
        {
            /*Actividades*/
            'template' : [
                {'tpl': '<div class="inter_size" id="menu_coin"><h1 style="position : absolute; top : 250px; left: 260px;">Córdoba</h1><button class="boton coin" id="btn_cordoba" data="C$ "></button><h1 style="position : absolute; top : 250px; left: 870px;">Dolar</h1><button class="boton coin" id="btn_dolar" data="$ "></button><button class="boton button btn_atras"></button></div>'},
                
                {'tpl' : '<div class="inter_size" id="int_nyd"><h1 class="tuto">Con ayuda de tus padres utiliza recibos de compra y clasifícalos en la columna segun corresponda. Al final agrega los precios para obtener un total de gastos.</h1><div class="table"><table id="tb1"><tr class="tr_indice"><th><h1>Necesidad</h1></th><th><h1>Costo</h1></th><th><h1>Deseo</h1></th><th><h1>Costo</h1></th></tr></table></div><button class="btn_acep boton" id="btn_calc_nyd">Aceptar</button><button class="boton button btn_atras"></button><audio id="player" src="../sound/error.ogg"></audio></div>'},
